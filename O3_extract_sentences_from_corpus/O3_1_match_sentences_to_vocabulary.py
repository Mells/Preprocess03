            ...
            if isinstance(lemma_pos_as_list[0], list):
                ...
                if do_compute:
                    ...
                    for index in set_index:
                        ...
                        s_out.write(
                            str([lemma_pos_as_list, chapter, book, sentence[0], sentence[1], sentence[2]]) + "\n")
...
if __name__ == "__main__":
    ...
    with open("./output/03_1_sentences_from_corpus.txt", "w") as s_out:
        for xml_voc in voc_root.findall('vocable'):
            ...
            print(num_voc, ";", 3022, " ; ", voc_as_lemma, ";", end="")
            ...
            if isinstance(lemma_pos_as_list[0], list):
                ...
                print(len(half_finished_vocable_list))
